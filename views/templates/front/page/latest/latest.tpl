...
*}
<div class="ui-grid-a grid-latest" style="margin-top: 35px;">
  {if empty($product)}{l s='No Product' mod='presmobileapp'}{/if}
  {if !empty($product)}
...
<div class="ui-grid-a">
  <div class="ba_load_lastest presmobi_loadting_latest">
