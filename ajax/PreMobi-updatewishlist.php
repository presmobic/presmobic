...
$sql = "UPDATE " . _DB_PREFIX_ . "wishlist SET `default`=0 WHERE id_customer=".(int)$context->customer->id."";
$db->query($sql);
$sql = "UPDATE " . _DB_PREFIX_ . "wishlist SET `default`=1 WHERE id_wishlist=".(int)$id_wishlist."";
$db->query($sql);
