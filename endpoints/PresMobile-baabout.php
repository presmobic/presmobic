...
class BaAbout extends PresMobileApp
{
    ...
    public function start($arg)
    {
        ...
        if ($check_cache != '') {
            $result = array(
                ...
                'content' => $check_cache,
                'batitle' =>'About us - '.$shop_name,
                'description' => 'About us - '.$shop_name
            );
            echo json_encode($result);
            die;
        }
        $term = "SELECT * FROM " . _DB_PREFIX_ . "cms_lang WHERE id_cms =4";
        ...
        $a = _PS_MODULE_DIR_ . '/presmobileapp/views/templates/front/page/about/about.tpl';
